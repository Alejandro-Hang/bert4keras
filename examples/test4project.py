...
# 标注数据
train_data = load_data('datasets/base_train_tiny.txt')
valid_data = load_data('datasets/base_val_tiny.txt')
test_data = load_data('datasets/base_test_tiny.txt')
